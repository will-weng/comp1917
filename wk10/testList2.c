// Written by Michael Simarta // With the help of Bernice Chen. // //run this 
testList2.c file with a compilable List2.c //that should have the functions 
declared in List2.h implemented
 
#include <stdio.h> include <stdlib.h> include <assert.h> include "List2.h"
...
//function to test the removeUpperCase() function void test_removeUpperCase() {
